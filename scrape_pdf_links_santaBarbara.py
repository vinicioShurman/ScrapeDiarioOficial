...
browser.get("https://www.camarasantabarbara.sp.gov.br/Download/Listar/591")
...
for i in range(1):
    ...
    prefix = "https://www.camarasantabarbara.sp.gov.br/Arquivos/Downloads/"
...
all_urls_file_path = r"scrapped-urls-santaBarbara.json"
