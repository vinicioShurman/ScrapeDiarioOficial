...
browser.get("https://publicacoesmunicipais.com.br/eatos/hortolandia")
...
for i in range(30):
    ...
    prefix = "https://api.publicacoesmunicipais.com.br/api/"
    ...
    # Go to a specific xpath in the window, then click
    if i < 3:
        next_button = browser.find_element(By.XPATH, '//*[@id="__layout"]/section/section/main/section/section[2]/section/section/div/div/div[2]/ul/li[9]/a')
        next_button.click()
    elif i < 4:
        next_button = browser.find_element(By.XPATH, '//*[@id="__layout"]/section/section/main/section/section[2]/section/section/div/div/div[2]/ul/li[10]/a')
        next_button.click()
    else:
        next_button = browser.find_element(By.XPATH, '//*[@id="__layout"]/section/section/main/section/section[2]/section/section/div/div/div[2]/ul/li[11]/a')
        next_button.click()
...
all_urls_file_path = r"scrapped-urls-hortolandia.json"
