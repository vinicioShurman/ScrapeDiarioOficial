...
browser.get("https://www.montemor.sp.gov.br/portal/diario-oficial/5/01-01-2023/26-11-2023/0/0/0")
...
for i in range(1):
    ...
    prefix = "https://www.montemor.sp.gov.br/portal/diario-oficial/ver/"
...
all_urls_file_path = r"scrapped-urls-monteMor.json"
