...
browser.get("https://www.sumare.sp.gov.br/Diario.Oficial.php?edicao=todas")
...
for i in range(1):
    ...
    prefix = "https://www.sumare.sp.gov.br/pdfDiario.php?"
...
all_urls_file_path = r"scrapped-urls-sumare.json"
